...
elseif (APPLE)
  set(TOOLCHAIN_DIR "${USER_DIR}/.silabs/slt/installs/conan/p/gcc-aa892a1d82ccd8/p/bin/")
else()
  set(TOOLCHAIN_DIR "/bin/")
endif ()
...
elseif (WIN32)
  set(POST_BUILD_EXE "")
elseif (APPLE)
  set(POST_BUILD_EXE "${USER_DIR}/.silabs/slt/installs/archive/Commander.app")
else()
  set(POST_BUILD_EXE "")
endif ()
...
elseif (APPLE)
  set(NINJA_RUNTIME_PATH "${USER_DIR}/.silabs/slt/installs/conan/p/ninjabaddce5497289/p/ninja")
else()
  set(NINJA_RUNTIME_PATH "")
endif ()
